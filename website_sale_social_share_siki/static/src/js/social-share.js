    ...
    (function ($) {
        ...
        $.fn.shareButtons = function (url, options) {
            ...
            var shareURLs = {
                ...
                'tumblr' : 'https://wa.me/?text=' + url_encoded,
            ...
            this.each(function(i){
                ...
                if(options.facebook){
                    ...
                    if( button.length == 0 ) {
                        elem.append($('<a class="btn-social-share btn-social-share-facebook" style="margin-right: 2.1%;" href="' + shareURLs.facebook +  '" ><i class="fa fa-facebook-square"></i></a>'));
                    } else {
                ...
                if(options.twitter){
                    ...
                    if( button.length == 0 ) {
                        elem.append($('<a class="btn-social-share btn-social-share-twitter" style="margin-right: 2.1%;" href="' + shareURLs.twitter + '" ><i class="fa fa-twitter"></i></a>'));
                    } else {
                ...
                */
                ...
                if(options.pinterest){
                    ...
                    if( button.length == 0 ) {
                        elem.append($('<a class="btn-social-share btn-social-share-pinterest" style="margin-right: 2.1%;" href="' + shareURLs.pinterest +  '" ><i class="fa fa-pinterest"></i></a>'));
                    } else {
                ...
                if(options.tumblr){
                    ...
                    if( button.length == 0 ) {
                        elem.append($('<a class="btn-social-share btn-social-share-tumblr" style="margin-right: 2.1%;" href="' + shareURLs.tumblr +  '" ><i class="fa fa-whatsapp"></i></a>'));
                    } else {
